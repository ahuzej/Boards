...
import ContainedTextBlock from "../ui/ContainedTextBlock";
...
function ThreadComment(props) {
  ...
  return (
    <div className={className}>
      <div className='avatar-user-section'>
        <AvatarPane centered={true} author={author} />
        <Divider />
        <div className="avatar-arrows">
          <div className="avatar-arrow-section">
            <div className="arrow" onClick={() => handleRating("upvote")}>
              <UpArrow
                fill={comment.userRating === "upvote" ? "green" : "#ccc"}
                alt=""
              />
            </div>
          </div>
          {rating.total}
          <div
            className="avatar-arrow-section"
            onClick={() => handleRating("downvote")}
          >
            <div className="arrow">
              <DownArrow
                fill={comment.userRating === "downvote" ? "red" : "#ccc"}
              />
            </div>
          </div>
        </div>
      ...
      <div className="thread-text">
        <ContainedTextBlock>{comment.text}</ContainedTextBlock>
